...
export default function ExchangePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div
        className="
          pointer-events-none fixed inset-x-0 top-0 z-30 h-32
          bg-gradient-to-b from-[#050505] via-[#050505]/92 to-transparent
        "
      />
      ...
      <section
        className="relative z-10 mx-auto max-w-6xl px-6 pb-12 pt-36"
      >
        <Link
          href="/"
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 max-w-2xl text-lg leading-8 text-white/60">
            Hier findest du Dienste, für die aktuell eine Vertretung gesucht
            wird. Du kannst einen offenen Dienst unabhängig von einem eigenen
            Tausch übernehmen.
          </p>
        </div>

        <div
          className="mb-8 rounded-[28px] border border-amber-400/20 bg-amber-400/[0.07] p-6 backdrop-blur-2xl"
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-white/60">
                Öffne einen verfügbaren Dienst und wähle „Übernehmen“. Nach
                deiner Bestätigung wird der Dienst direkt auf dich übertragen.
                Ein Gegentausch ist nicht erforderlich.
              </p>
            </div>
          </div>
        </div>
            ...
            <h2 className="mt-1 text-2xl font-bold text-white">
              {openServices.length === 0
                ...
                : `${openServices.length} offene ${
                    openServices.length === 1 ? "Dienst" : "Dienste"
                  }`}
            </h2>
          </div>
        ...
        {openServices.length === 0 && (
          <div className="rounded-[30px] border border-white/10 bg-white/[0.045] p-10 text-center backdrop-blur-2xl">
            ...
            <p className="mx-auto mt-2 max-w-md text-white/50">
              Momentan gibt es keine offenen Dienste, für die eine Vertretung
              gesucht wird.
            </p>
            ...
            <Link
              href="/services"
              className="
                mt-6 inline-flex items-center gap-2 rounded-xl border border-white/10
                bg-white/[0.05] px-5 py-3 text-sm font-semibold text-white/70
                transition hover:border-amber-400/20 hover:bg-amber-400/10
...
function ExchangeServiceCard({
  ...
  return (
    <div
      className="
        rounded-[28px] border border-white/10 bg-white/[0.045] p-6
        backdrop-blur-2xl transition hover:border-amber-400/20 hover:bg-white/[0.06]
      "
    >
        ...
        <div className="flex shrink-0 flex-col gap-3 lg:w-56">
          <button
            ...
            className="
              ...
              border-amber-400/25 bg-amber-400/10 px-5 py-4 font-semibold
              text-amber-200 transition hover:border-amber-400/40
              hover:bg-amber-400/15 hover:text-amber-100
            "
          >
            <RefreshCcw size={18} />
            Übernehmen
          ...
          <Link
            ...
            className="rounded-xl px-4 py-2 text-center text-sm text-white/40 transition hover:text-white/70"
          >
            Details anzeigen
          </Link>
        </div>
