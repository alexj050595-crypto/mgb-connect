  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 pb-16 pt-28 sm:px-6 sm:pt-36">
        ...
        <div className="mb-10 mt-8"><p className="text-sm uppercase tracking-[0.22em] text-amber-300/80">Administration</p><h1 className="mt-2 text-3xl font-black tracking-tight text-white sm:text-5xl">Benutzerverwaltung</h1><p className="mt-3 text-lg text-white/60">Accounts, Rollen, Aktivierung und Zugangsdaten direkt aus MGB Connect verwalten.</p></div>
